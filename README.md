...
### Построить графики зависимости количества эпох от ошибки  обучения. Указать от чего зависит необходимое количество эпох обучения. 
  ...
  ![изображение](https://github.com/lexaSvarshik/lab4/assets/96281939/fa609194-6662-44b7-aaa9-2edf2dbd529d)


Количество эпох зависит отнескольких факторов:

    от weights(веса), значение которого мы получаем при успешном выполнении условия и удовлетворении пороговому значению, пройти которон можно набрав определёнынй "вес"
    от логической функции, поскольку разные функции требует разного количества итераций для обучения (или вовсе неразрешимы при данной установке в 1 перцептрон без скрытых нейронных слоёв)
...
Наглядная демонстрация есть в [.exe файле](https://github.com/lexaSvarshik/lab4/releases/tag/demo) (лежит в релизах)
